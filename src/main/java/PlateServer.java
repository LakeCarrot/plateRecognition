...
public class PlateServer {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
	...
	static class PlateRecognitionImpl extends PlateRecognitionGrpc.PlateRecognitionImplBase {
		...
		@Override
		public StreamObserver<PlateRecognitionRequest> offloading(final StreamObserver<PlateRecognitionReply> responseObserver) {
			return new StreamObserver<PlateRecognitionRequest>() {
				@Override
				public void onNext(PlateRecognitionRequest request) {
    			logger.info("receive a message!");
					byte[] data = request.getData().toByteArray();
					String name = request.getName();
    			logger.info("parse a message!");
					try {
				...
				public void onCompleted() {
					responseObserver.onNext(PlateRecognitionReply.newBuilder().setMessage(mMessage).build());
